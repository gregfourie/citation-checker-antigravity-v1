...
export default function Hopper({ onExtract, isExtracting }: HopperProps) {
  ...
  return (
    <section className="card">
      ...
      <p style={{ color: 'var(--stone)', marginBottom: '16px' }}>
        Upload a Word Document/PDF or paste text directly to extract citations and begin the audit process.
      </p>
      ...
      <div style={{ marginBottom: '24px', display: 'flex', gap: '16px' }}>
        <button 
          ...
          style={{ 
            ...
            color: inputMode === 'file' ? 'var(--cream)' : 'var(--ink)',
        ...
        <button 
          ...
          style={{ 
            ...
            color: inputMode === 'text' ? 'var(--cream)' : 'var(--ink)',
            border: '1px solid var(--forest)'
          }}
        >
          Paste Text
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '500px' }}>
        ...
        {inputMode === 'file' ? (
          ...
          <textarea
            ...
            placeholder="Paste your text containing citations here..."
            style={{
              width: '100%',
              minHeight: '200px',
              padding: '16px',
        ...
        <button 
          type="submit" 
          disabled={isExtracting || (inputMode === 'file' ? !file : !text.trim())} 
